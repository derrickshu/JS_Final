     ...
     function(data) {
        L.geoJson(data, {
            pointToLayer: function(feature, latlng) { if (feature.properties.crash_year==value)
              { return L.circleMarker(latlng, myStyle(feature,latlng)).bindPopup('Year: '+feature.properties.crash_year+"<dd>"+"</dd>"+'Injury: '+feature.properties.injury_cou+"<dd>"+"</dd>"+'Fatal: '+feature.properties.fatal_coun+"<dd>"+"</dd>"+'People Involved: '+feature.properties.person_cou);}
              }
        }).addTo(map);
    });
});
